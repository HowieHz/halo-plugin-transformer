...
writeJsonc(
  path.join(repoRoot, 'contracts', 'match-rule-contract-checklist.generated.jsonc'),
  {
...
function writeJsonc(targetPath, value) {
  writeText(
    targetPath,
    [
      ...
      '// Run `pnpm generate:contracts` in `ui/` to regenerate it.',
