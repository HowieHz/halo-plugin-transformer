...
export function useTransformerData(activeTab: Ref<ActiveTab>) {
  ...
  return {
    ...
    ruleCompatibilityStatus: ruleState.compatibilityStatus,
    ruleCompatibilityStep: ruleState.compatibilityStep,
    ...
    startRuleCompatibilityCheck: ruleState.startRuleCompatibilityCheck,
    answerRuleCompatibilityCheck: ruleState.answerRuleCompatibilityCheck,
    undoRuleCompatibilityCheck: ruleState.undoRuleCompatibilityCheck,
    stopRuleCompatibilityCheck: ruleState.stopRuleCompatibilityCheck,
