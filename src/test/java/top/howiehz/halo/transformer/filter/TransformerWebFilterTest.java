...
class TransformerWebFilterTest {
    ...
    void shouldResolveRuleCodesOnceAndParseHtmlOnlyOnceWhenApplyingMultipleDomRules() {
        TransformationRule selectorRule = domRule("rule-selector", TransformationRule.Mode.SELECTOR, ".slot");
        TransformationRule secondSelectorRule = domRule("rule-selector-2", TransformationRule.Mode.SELECTOR, "main");
        ...
        when(transformHelper.resolveRuleCodes(List.of(runtimeSelectorRule, runtimeSecondSelectorRule))).thenReturn(
                Mono.just(List.of(
                        new TransformHelper.ResolvedRuleCode(runtimeSelectorRule, "<span class='selector'>S</span>"),
                        new TransformHelper.ResolvedRuleCode(runtimeSecondSelectorRule, "<span class='second'>I</span>")
                ))
        );
        ...
        verify(transformHelper).resolveRuleCodes(List.of(runtimeSelectorRule, runtimeSecondSelectorRule));
    ...
    void shouldDecorateRequestBeforeResponseStatusIsCommitted() {
        ...
        when(transformHelper.resolveRuleCodes(List.of(runtimeSelectorRule))).thenReturn(Mono.just(List.of(
                new TransformHelper.ResolvedRuleCode(runtimeSelectorRule, "<span class='selector'>S</span>")
        )));
